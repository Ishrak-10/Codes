...
public class BasicCalculator implements ICalculation
{
	...
	public double add(){return this.value1+this.value2;}
	public double subtract(){return this.value1-this.value2;}
	public double multiply(){return this.value1*this.value2;}
	public double divide(){return this.value1/this.value2;}
}